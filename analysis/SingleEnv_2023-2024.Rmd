...
megaLMM of each location individually 2023-2024
...
here::i_am("analysis/SingleEnv_2023-2024.Rmd")
```
...
# Unique year, pea ID
Image(as.matrix(table(yield_data2$germplasmName,yield_data2$peaAcc))) + theme(legend.position = 'none') + xlab('Environment') + ylab('germplasmName') # all locations
```
...
# large parts of the pipeline from JL : ~/DSFAS_Recommending/analysis/WashingtonSoftSpringWheatTrials.Rmd
...
Image(as.matrix(table(yield_data3$germplasmName,yield_data3$peaAcc))) + theme(legend.position = 'none') + xlab('Environment') + ylab('germplasmName')
```
...
all(rownames(GRM) %in% sample_data$germplasmName)
```
...
seed <- 6234
set.seed(seed)
runID <- paste0("NY2023_", seed) # Will make a folder with this name
```
...
runID <- paste0("output/megaLMM/individualLOC_2023-2024/", runID, "CV2")
...
for (trialName in testTrials){
  for (cvFold in 1:nCVfolds){
    ...
    saveRDS(MegaLMM_state, file = here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "NY2023_MegaLMM_state.rds")))
  ...
  saveRDS(list(allLambdaPost=allLambdaPost, allCorr=allCorr), 
          file=here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "NY2023_MegaLMMresultsCV2.rds")))
}#END trial
...
for(i in 1:ncol(yldWide)) {
  ...
  saveRDS(rrBLUP_predictions, file=here::here("output", "megaLMM", "individualLOCgBLUP_2023-2024", paste0(seed, "NY2023_rrBLUPresultsCV2.rds")))
}
```
...
```{r}
# MegaLMM_state = readRDS(here::here('output', 'megaLMM', 'individualLOC_2023-2024', '6234NY2023_MegaLMM_state.rds'))
# rrBLUP_predictions = readRDS(here::here('output', 'megaLMM', 'individualLOCgBLUP_2023-2024', '6234NY2023_rrBLUPresultsCV2.rds'))

# yldTest <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "NY2023_6234CV2", "Y_testing.rds"))
# yldTrain <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "NY2023_6234CV2", "Y_training.rds"))
# yldWide <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "NY2023_6234CV2", "pheno_input.rds"))
```
...
MegaLMM_Uhat_accuracy = diag(cor(yldTest,U_hat,use='p'))
MegaLMM_Eta_mean_accuracy = diag(cor(yldTest,Eta_mean,use='p'))
plot(rrBLUP_accuracy,MegaLMM_Uhat_accuracy);abline(0,1) # saved as output/MegaLMM/individualLOC_2023-2024/figures/Prediction_Accuracy_Comparison_NY2023
...
for (trialName in testTrials){
  for (cvFold in 1:nCVfolds){
    ...
    MegaLMM_state <- sample_MegaLMM(MegaLMM_state, n_iter, verbose=F)
    MegaLMM_state <- save_posterior_chunk(MegaLMM_state)
    saveRDS(MegaLMM_state, file = here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "NY2024_MegaLMM_state.rds")))
  ...
  saveRDS(list(allLambdaPost=allLambdaPost, allCorr=allCorr), 
          file=here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "NY2024_MegaLMMresultsCV2.rds")))
}#END trial
# save files used in posterior eval
saveRDS(yldTest, file = here::here(runID, "Y_testing.rds"))
saveRDS(yldTrain, file = here::here(runID, "Y_training.rds"))
...
for(i in 1:ncol(yldWide)) {
  ...
  res = mixed.solve(y = yldTrain[,i],
                                       ...
                                       K = GRM)
  rrBLUP_predictions[,i] = c(X %*% res$beta) + res$u
  saveRDS(rrBLUP_predictions, file=here::here("output", "megaLMM", "individualLOCgBLUP_2023-2024", paste0(seed, "NY2024_rrBLUPresultsCV2.rds")))
}
```
...
```{r}
# MegaLMM_state = readRDS(here::here('output', 'megaLMM', 'individualLOC_2023-2024', '6234NY2024_MegaLMM_state.rds'))
# rrBLUP_predictions = readRDS(here::here('output', 'megaLMM', 'individualLOCgBLUP_2023-2024', '6234NY2024_rrBLUPresultsCV2.rds'))

# yldTest <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "NY2024_6234CV2", "Y_testing.rds"))
# yldTrain <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "NY2024_6234CV2", "Y_training.rds"))
# yldWide <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "NY2024_6234CV2", "pheno_input.rds"))
```
...
MegaLMM_Uhat_accuracy = diag(cor(yldTest,U_hat,use='p'))
MegaLMM_Eta_mean_accuracy = diag(cor(yldTest,Eta_mean,use='p'))
plot(rrBLUP_accuracy,MegaLMM_Uhat_accuracy);abline(0,1) # saved as output/MegaLMM/individualLOC_2023-2024/figures/Prediction_Accuracy_Comparison_NY2024
plot(rrBLUP_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
plot(MegaLMM_Uhat_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
```
...
for (trialName in testTrials){
  for (cvFold in 1:nCVfolds){
    ...
    MegaLMM_state <- sample_MegaLMM(MegaLMM_state, n_iter, verbose=F)
    MegaLMM_state <- save_posterior_chunk(MegaLMM_state)
    saveRDS(MegaLMM_state, file = here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "IL2023_MegaLMM_state.rds")))
  ...
  saveRDS(list(allLambdaPost=allLambdaPost, allCorr=allCorr), 
          file=here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "IL2023_MegaLMMresultsCV2.rds")))
}#END trial
# save files used in posterior eval
saveRDS(yldTest, file = here::here(runID, "Y_testing.rds"))
saveRDS(yldTrain, file = here::here(runID, "Y_training.rds"))
...
for(i in 1:ncol(yldWide)) {
  ...
  res = mixed.solve(y = yldTrain[,i],
                                       ...
                                       K = GRM)
  rrBLUP_predictions[,i] = c(X %*% res$beta) + res$u
  saveRDS(rrBLUP_predictions, file=here::here("output", "megaLMM", "individualLOCgBLUP_2023-2024", paste0(seed, "IL2023_rrBLUPresultsCV2.rds")))
}
```
...
```{r}
# MegaLMM_state = readRDS(here::here('output', 'megaLMM', 'individualLOC_2023-2024', '6234IL2023_MegaLMM_state.rds'))
# rrBLUP_predictions = readRDS(here::here('output', 'megaLMM', 'individualLOCgBLUP_2023-2024', '6234IL2023_rrBLUPresultsCV2.rds'))

# yldTest <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "IL2023_6234CV2", "Y_testing.rds"))
# yldTrain <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "IL2023_6234CV2", "Y_training.rds"))
# yldWide <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "IL2023_6234CV2", "pheno_input.rds"))
```
...
MegaLMM_Uhat_accuracy = diag(cor(yldTest,U_hat,use='p'))
MegaLMM_Eta_mean_accuracy = diag(cor(yldTest,Eta_mean,use='p'))
plot(rrBLUP_accuracy,MegaLMM_Uhat_accuracy);abline(0,1) # saved as output/MegaLMM/individualLOC_2023-2024/figures/Prediction_Accuracy_Comparison_IL2023
plot(rrBLUP_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
plot(MegaLMM_Uhat_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
```
...
for (trialName in testTrials){
  for (cvFold in 1:nCVfolds){
    ...
    yldTest <- yldWide
    nAccInTrial <- sum(!is.na(yldTrain[, trialName]))
    setMissing <- sample(nAccInTrial, size=nAccInTrial / 2 , replace=F) # dropping all environments 
    yldTrain[!is.na(yldTrain[, trialName]), trialName][setMissing] <- NA
    yldTest[which(!is.na(yldTest[, trialName]))[-setMissing], trialName] <- NA
    ...
    MegaLMM_state <- sample_MegaLMM(MegaLMM_state, n_iter, verbose=F)
    MegaLMM_state <- save_posterior_chunk(MegaLMM_state)
    saveRDS(MegaLMM_state, file = here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "IL2024_MegaLMM_state.rds")))
  ...
  saveRDS(list(allLambdaPost=allLambdaPost, allCorr=allCorr), 
          file=here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "IL2024_MegaLMMresultsCV2.rds")))
}#END trial
# save files used in posterior eval
saveRDS(yldTest, file = here::here(runID, "Y_testing.rds"))
saveRDS(yldTrain, file = here::here(runID, "Y_training.rds"))
...
for(i in 1:ncol(yldWide)) {
  ...
  res = mixed.solve(y = yldTrain[,i],
                                       ...
                                       K = GRM)
  rrBLUP_predictions[,i] = c(X %*% res$beta) + res$u
  saveRDS(rrBLUP_predictions, file=here::here("output", "megaLMM", "individualLOCgBLUP_2023-2024", paste0(seed, "IL2024_rrBLUPresultsCV2.rds")))
}
```
...
```{r}
# MegaLMM_state = readRDS(here::here('output', 'megaLMM', 'individualLOC_2023-2024', '6234IL2024_MegaLMM_state.rds'))
# rrBLUP_predictions = readRDS(here::here('output', 'megaLMM', 'individualLOCgBLUP_2023-2024', '6234IL2024_rrBLUPresultsCV2.rds'))

# yldTest <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "IL2024_6234CV2", "Y_testing.rds"))
# yldTrain <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "IL2024_6234CV2", "Y_training.rds"))
# yldWide <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "IL2024_6234CV2", "pheno_input.rds"))
```
...
MegaLMM_Uhat_accuracy = diag(cor(yldTest,U_hat,use='p'))
MegaLMM_Eta_mean_accuracy = diag(cor(yldTest,Eta_mean,use='p'))
plot(rrBLUP_accuracy,MegaLMM_Uhat_accuracy);abline(0,1)  # saved as output/MegaLMM/individualLOC_2023-2024/figures/Prediction_Accuracy_Comparison_IL2024
plot(rrBLUP_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
plot(MegaLMM_Uhat_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
```
...
for (trialName in testTrials){
  for (cvFold in 1:nCVfolds){
    ...
    MegaLMM_state <- sample_MegaLMM(MegaLMM_state, n_iter, verbose=F)
    MegaLMM_state <- save_posterior_chunk(MegaLMM_state)
    saveRDS(MegaLMM_state, file = here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "SD2023_MegaLMM_state.rds")))
  ...
  saveRDS(list(allLambdaPost=allLambdaPost, allCorr=allCorr), 
          file=here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "SD2023_MegaLMMresultsCV2.rds")))
}#END trial
# save files used in posterior eval
saveRDS(yldTest, file = here::here(runID, "Y_testing.rds"))
saveRDS(yldTrain, file = here::here(runID, "Y_training.rds"))
...
for(i in 1:ncol(yldWide)) {
  ...
  res = mixed.solve(y = yldTrain[,i],
                                       ...
                                       K = GRM)
  rrBLUP_predictions[,i] = c(X %*% res$beta) + res$u
  saveRDS(rrBLUP_predictions, file=here::here("output", "megaLMM", "individualLOCgBLUP_2023-2024", paste0(seed, "SD2023_rrBLUPresultsCV2.rds")))
}
```
...
```{r}
# MegaLMM_state = readRDS(here::here('output', 'megaLMM', 'individualLOC_2023-2024', '6234SD2023_MegaLMM_state.rds'))
# rrBLUP_predictions = readRDS(here::here('output', 'megaLMM', 'individualLOCgBLUP_2023-2024', '6234SD2023_rrBLUPresultsCV2.rds'))

# yldTest <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "SD2023_6234CV2", "Y_testing.rds"))
# yldTrain <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "SD2023_6234CV2", "Y_training.rds"))
# yldWide <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "SD2023_6234CV2", "pheno_input.rds"))
```
...
MegaLMM_Uhat_accuracy = diag(cor(yldTest,U_hat,use='p'))
MegaLMM_Eta_mean_accuracy = diag(cor(yldTest,Eta_mean,use='p'))
plot(rrBLUP_accuracy,MegaLMM_Uhat_accuracy);abline(0,1) # saved as output/MegaLMM/individualLOC_2023-2024/figures/Prediction_Accuracy_Comparison_SD2023
plot(rrBLUP_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
plot(MegaLMM_Uhat_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
```
...
for (trialName in testTrials){
  for (cvFold in 1:nCVfolds){
    ...
    MegaLMM_state <- sample_MegaLMM(MegaLMM_state, n_iter, verbose=F)
    MegaLMM_state <- save_posterior_chunk(MegaLMM_state)
    saveRDS(MegaLMM_state, file = here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "SD2024_MegaLMM_state.rds")))
  ...
  saveRDS(list(allLambdaPost=allLambdaPost, allCorr=allCorr), 
          file=here::here("output", "megaLMM", "individualLOC_2023-2024", paste0(seed, "SD2024_MegaLMMresultsCV2.rds")))
}#END trial
# save files used in posterior eval
saveRDS(yldTest, file = here::here(runID, "Y_testing.rds"))
saveRDS(yldTrain, file = here::here(runID, "Y_training.rds"))
...
for(i in 1:ncol(yldWide)) {
  ...
  res = mixed.solve(y = yldTrain[,i],
                                       ...
                                       K = GRM)
  rrBLUP_predictions[,i] = c(X %*% res$beta) + res$u
  saveRDS(rrBLUP_predictions, file=here::here("output", "megaLMM", "individualLOCgBLUP_2023-2024", paste0(seed, "SD2024_rrBLUPresultsCV2.rds")))
}
```
...
```{r}
# MegaLMM_state = readRDS(here::here('output', 'megaLMM', 'individualLOC_2023-2024', '6234SD2024_MegaLMM_state.rds'))
# rrBLUP_predictions = readRDS(here::here('output', 'megaLMM', 'individualLOCgBLUP_2023-2024', '6234SD2024_rrBLUPresultsCV2.rds'))

# yldTest <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "SD2024_6234CV2", "Y_testing.rds"))
# yldTrain <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "SD2024_6234CV2", "Y_training.rds"))
# yldWide <- readRDS(here::here("output", "megaLMM", "individualLOC_2023-2024", "SD2024_6234CV2", "pheno_input.rds"))
```
...
MegaLMM_Uhat_accuracy = diag(cor(yldTest,U_hat,use='p'))
MegaLMM_Eta_mean_accuracy = diag(cor(yldTest,Eta_mean,use='p'))
plot(rrBLUP_accuracy,MegaLMM_Uhat_accuracy);abline(0,1) # saved as output/MegaLMM/individualLOC_2023-2024/figures/Prediction_Accuracy_Comparison_SD2024
plot(rrBLUP_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
plot(MegaLMM_Uhat_accuracy,MegaLMM_Eta_mean_accuracy);abline(0,1)
```
...
```{r Read CV2 MegaLMM results}
CV2dir <- here::here("output", "megaLMM", "individualLOC_2023-2024")
files <- list.files(path=CV2dir, pattern = "MegaLMMresultsCV2", full.names = TRUE)
df_list <- lapply(files, readRDS)

allCorrCV2 <- Reduce(function(x, y) bind_rows(x, y$allCorr), 
                  init=tibble(), df_list)
allCorrCV2 <- allCorrCV2 |> group_by(trial) |> 
  summarize(medGenAcc=median(genAcc), medPhenAcc=median(phenAcc))
badTrialsCV2 <- allCorrCV2 |> filter(medGenAcc < 0.4)
summary(allCorrCV2$medGenAcc)
summary(allCorrCV2$medPhenAcc)
boxplot(allCorrCV2[, c("medGenAcc", "medPhenAcc")])
plot(allCorrCV2[, c("medGenAcc", "medPhenAcc")])
```

```{r}
rm(CV2dir,files, df_list, allCorrCV2, badTrialsCV2)
```
